...
class ComplaintCategory(models.Model):
    ...
    ethiopian_date_of_remedy = fields.Date(string="In Ethiopian date of remedy")
    ...
    def create(self, vals):
        ...
        try:
            if vals['date_of_remedy'] is not None:
                ...
                date2 = vals['date_of_remedy']
                Edate1 = EthiopianDateConverter.to_ethiopian(date1.year,date1.month,date1.day)
                Edate2 = EthiopianDateConverter.to_ethiopian(date2.year,date2.month,date2.day)
                vals['ethiopian_date_of_remedy'] = Edate2
                vals['ethiopian_date_of_remedy'] = Edate1
        except:
            pass
       
        return super(ComplaintCategory, self).create(vals)
    ...
    def write(self, vals):
        ...
        return super(ComplaintCategory, self).write(vals)
