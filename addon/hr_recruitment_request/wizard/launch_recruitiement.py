...
class LaunchRecruitment(models.TransientModel):
    _name = 'launch.recruitment.wizard'
    _description = 'New recruitment '

    @api.model
    def default_get(self, fields):
        res = super(LaunchRecruitment, self).default_get(fields)
